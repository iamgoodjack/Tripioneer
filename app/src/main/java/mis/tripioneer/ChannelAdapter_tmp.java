 ...
 */
public class ChannelAdapter_tmp extends BaseAdapter
{
    ...
    public ChannelAdapter_tmp(Context context) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.viewModels = new ArrayList<ViewModel>();
    }

    public ChannelAdapter_tmp(Context context, List<ViewModel> viewModels) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
