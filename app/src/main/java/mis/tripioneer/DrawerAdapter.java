...
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder>
{
    ...
    public static IMyViewHolderClicks mListener = null;

    public interface IMyViewHolderClicks
    {
        void onTitle(View caller, String tag);
        void onIcon(ImageView callerImage, String tag);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public ViewHolder(View itemView, int ViewType)
        {
            ...
            {
                textView = (TextView) itemView.findViewById(R.id.txtItem); // Creating TextView object with the id of textView from item_row.xml
        ...
        public void onClick(View v)
        {
            ...
            if (mListener != null)
            {
                ...
                {
                    mListener.onIcon((ImageView) v, (String) v.getTag());
                    Log.d(TAG, "onClick, getTag=" + v.getTag());
                }
                else
                {
                    mListener.onTitle(v,(String)v.getTag());
                    Log.d(TAG, "onClick, getTag=" + v.getTag());
                }
            }
        }
    ...
    public DrawerAdapter(String Titles[],int Icons[],String Name,String Email, int Profile, IMyViewHolderClicks listener)
    ...
    //Created, In this method we inflate the drawer_list_item.xml layout if the viewType is Type_ITEM or else we inflate header.xml
    ...
    // which view type is being created . For example, 1 for item row
    @Override
    public void onBindViewHolder(DrawerAdapter.ViewHolder holder, int position)
    {
        ...
        {   // as the list view is going to be called after the header view so we decrement the
            ...
            holder.imageView.setTag(mNavTitles[position - 1]);
            Log.d(TAG, "setTag = " + mNavTitles[position - 1]);
        }
        else
        {
